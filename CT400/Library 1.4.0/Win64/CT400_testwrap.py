...
# version 1.4.0 
# tested successfully with Python 2.7.7 and Phyton 3.4.2
...
def main():	 
	...
	if uiHandle:
		...
		if windll.CT400_lib.CT400_CheckConnected(uiHandle):
			...
			windll.CT400_lib.CT400_SetLaser(uiHandle, LI_2, ENABLE, 11, LS_TunicsT100s_HP, c_double(1350.0), c_double(1510.0), 100)
			# configure laser sweep
			windll.CT400_lib.CT400_SetScan(uiHandle, c_double(5.0), c_double(1350.0), c_double(1400.0))
			windll.CT400_lib.CT400_SetSamplingResolution(uiHandle, 100)
			windll.CT400_lib.CT400_SetDetectorArray(uiHandle, DISABLE, DISABLE, DISABLE, ENABLE)
			...
			if iErrorID == 0:				
				...
				windll.CT400_lib.CT400_ScanSaveDetectorFile(uiHandle, DE_5, c_char_p(b"Output_Detector5_Sync.txt"))
				windll.CT400_lib.CT400_ScanSaveDetectorResampledFile(uiHandle,  DE_5, c_char_p(b"Output_Detector5_Resampled.txt"))
				...
				#---------------------------------------------------
				# Display the number of points for standard and resampled measurments
				...
				windll.CT400_lib.CT400_CmdLaser(uiHandle, LI_2, DISABLE, c_double(1500.0), c_double(1.0))
